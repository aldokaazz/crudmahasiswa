...
class Mahasiswa extends CI_Controller
{
  ...
  public function tambah()
  {
    ...
    $this->form_validation->set_rules('no_hp', 'No_HP', 'required|integer', [
    ...
    if ($this->form_validation->run() == false) {
      ...
      $this->session->set_flashdata('message', '<div class="alert alert-succes" role="alert">Data Mahasiswa Berhasil ditambah!!</div>');
      redirect('Mahasiswa');
    }
  }
  ...
  public function hapus($id)
  {
    ...
    $this->session->set_flashdata('message', '<div class="alert alert-succes" role="alert">Data Mahasiswa Berhasil dihapus!!</div>');
    redirect('Mahasiswa');
  }
